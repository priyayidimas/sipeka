...
@section('title')
Mahasiswa &middot; Submission Mahasiswa
@endsection
...
@section('heading')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{url('mhs/kelas/submission/'.$mt->kelas->id)}}"></i> Lihat Detail Kelas</a></li>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        @if($dikerjakan)
                                        <a href="{{url('mhs/kelas/periksa/'.$jawaban->first()->pivot->id)}}" class="btn btn-primary" style="padding:0px 5px;">Periksa Kerjaan</a>
                                        @else
